...
const Details = () => {
    ...
    const { destinations, getDestinations } = useContext(CartContext);
    ...
    useEffect(() => {
        ...
        if (user) {
            ...
            setDestination(userDestination != null ? userDestination.id : "");
        }
    }, [user]);
    ...
    //when destination select button is clicked
