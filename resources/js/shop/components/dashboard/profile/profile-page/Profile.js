...
const Profile = () => {
    ...
    return (
        <div className="bg-gray-100 block pb-16 h-full">
                ...
                <div className="md:flex no-wrap md:-mx-2 ">
                    ...
                    <div className="w-full md:w-3/12 md:mx-2">
                        ...
                        <div className="bg-white p-3 border-t-4 border-green-400">
                            ...
                            <ul className="block bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                                                                            ...
                                                                            {order?.products &&
                                                                                order.products.map(
                                                                                    prod => {
                                                                                        return (
                                                                                            <div
                                                                                                className="text-md font-light serif"
                                                                                                key={
                                                                                                    prod.id
                                                                                                }
                                                                                            >
                                    ...
                                    <ul className="list-inside space-y-2">
                                        {wishList?.length > 0 ? (
                                            wishList.map((wish, i) => {
                                                return (
                                                    <li key={i}>
                                                        <div className="text-teal-600 text-md font-light serif">
                                                            {wish.title}
                                                        </div>
                                                    </li>
                                                );
                                        ...
                                        {wishList?.length > 2 && (
                                            <div className="text-right mt-4 w-full">
                                                <Link
                                                    to="/wishlist"
                                                    className="text-center bg-blue-600 py-2 serif text-white mt-2 w-full px-4"
                                                >
                                                    Show all wish list
                                                </Link>
                                            </div>
